...
export const Navbar21Defaults = {
  ...
  buttonContact: { title: "Contact", variant: "link", size: "link", url: "#contact" },
  articleHeading: "Featured Work",
  articleButton: {
  ...
  articles: [
    {
      url: "#",
      heading: "Documentary Feature",
      description: "Captivating storytelling through color",
      image: {
    ...
    {
      url: "#",
      heading: "Fiction Short",
      description: "A journey through imagination and color",
      image: {
        src: "https://d22po4pjz3o32e.cloudfront.net/placeholder-image-landscape.svg",
